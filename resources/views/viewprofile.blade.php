                            ...
                            <div class="w-full md:w-3/12 md:mx-2">
                                ...
                                <div class="bg-white p-3 border-t-4 border-blue-400">
                                    ...
                                    <div class=" mt-4 flex items-center justify-center">
                                        <x-button class="w-full text-center" href="{{ route('profile-pic') }}">
                                            {{ __('Change Profile Picture') }}
                                        </x-button>
                                    </div>
                                    <div class=" mt-4 flex items-center justify-center">
                                        <x-button class="w-full text-center" href="{{ route('profile') }}">
                                            {{ __('Edit Profile') }}
                                        </x-button>
                                    </div>
                                    <div class=" mt-4 flex items-center justify-center">
                                        <x-button class="w-full text-center" href="{{ route('change-password') }}">
                                            {{ __('Change Password') }}
                                        </x-button>
                                    </div>
                                </div>
                                    ...
                                    <div class="text-gray-700">
                                        <div class="grid md:grid-cols-2 text-sm">
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                <div class="px-4 py-2">{{ auth()->user()->mobile }}</div>
                                            </div>
                                            <div class="grid grid-cols-2">
                                            ...
                                            <div class="grid grid-cols-2">
                                                ...
                                                <div class="px-4 py-2">{{ auth()->user()->current_residence }}</div>
                                            </div>
                                            <div class="grid grid-cols-2">
