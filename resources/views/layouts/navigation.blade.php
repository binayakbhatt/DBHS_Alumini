<nav class="bg-gradient-to-r from-blue-500 to-blue-300 border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center justify-end space-x-8 ">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    ...
                    <button
                        class=" hidden md:block bg-transparent hover:bg-red-900 text-white font-bold py-2 px-4 rounded-full border border-white border-solid border-2 ">
                        Logout</button>
                </form>
            </div>
